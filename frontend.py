...
# Locally this defaults to your laptop's backend.
# Once deployed, set API_URL in Streamlit Cloud's "Secrets" to your Railway URL.
API_URL = os.getenv("API_URL", "http://127.0.0.1:8000")

st.set_page_config(page_title="Day 21 - Deployed App", page_icon="🚀")
st.title("🚀 Day 21 — Deployed Full Stack App")
